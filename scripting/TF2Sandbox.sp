...
public void OnPluginStart()
{
	...
	AddMenuItem(g_hPropMenuWeapons, "bootlegger", "The Bootlegger");
	...
	AddMenuItem(g_hPropMenuWeapons, "quackenbirdt", "The Quackenbirdt");
	...
	AddMenuItem(g_hPropMenuWeapons, "snackattack", "The Snack Attack");
	...
	AddMenuItem(g_hPropMenuWeapons, "splendidscreen", "The Splendid Screen");
	...
	AddMenuItem(g_hPropMenuWeapons, "ttgwatch", "The TTG Watch");
	...
	AddMenuItem(g_hPropMenuCosmetics, "ahattokillfor", "A Hat to Kill For");
	AddMenuItem(g_hPropMenuCosmetics, "aheadfullofhotair", "A Head Full of Hot Air");
	AddMenuItem(g_hPropMenuCosmetics, "airdog", "Airdog");
	AddMenuItem(g_hPropMenuCosmetics, "aliencranium", "Alien Cranium");
	AddMenuItem(g_hPropMenuCosmetics, "allbrero", "Allbrero");
	AddMenuItem(g_hPropMenuCosmetics, "alternativemedicinemann", "Alternative Medicine Mann");
	AddMenuItem(g_hPropMenuCosmetics, "anger", "Anger");
	AddMenuItem(g_hPropMenuCosmetics, "archerssterling", "Archer's Sterling");
	AddMenuItem(g_hPropMenuCosmetics, "area451", "Area 451");
	AddMenuItem(g_hPropMenuCosmetics, "armoredauthority", "Armored Authority");
	AddMenuItem(g_hPropMenuCosmetics, "attendant", "Attendant");
	AddMenuItem(g_hPropMenuCosmetics, "aviatorassassin", "Aviator Assassin");
	AddMenuItem(g_hPropMenuCosmetics, "aztecaggressor", "Aztec Aggressor");
	AddMenuItem(g_hPropMenuCosmetics, "baaarrghnbicorne", "B'aaarrgh-n-Bicorne");
	...
	AddMenuItem(g_hPropMenuCosmetics, "bacteriablocker", "Bacteria Blocker");
	AddMenuItem(g_hPropMenuCosmetics, "barnstormer", "Barnstormer");
	...
	AddMenuItem(g_hPropMenuCosmetics, "baseballbillssportsshine", "Baseball Bill's Sports Shine");
	AddMenuItem(g_hPropMenuCosmetics, "battershelmet", "Batter's Helmet");
	AddMenuItem(g_hPropMenuCosmetics, "battlebird", "Battle Bird");
	AddMenuItem(g_hPropMenuCosmetics, "battlebob", "Battle Bob");
	AddMenuItem(g_hPropMenuCosmetics, "battleboonie", "Battle Boonie");
	AddMenuItem(g_hPropMenuCosmetics, "bearnecessities", "Bear Necessities");
	AddMenuItem(g_hPropMenuCosmetics, "beastlybonnet", "Beastly Bonnet");
	...
	AddMenuItem(g_hPropMenuCosmetics, "berlinbrainbowl", "Berlin Brain Bowl");
	...
	AddMenuItem(g_hPropMenuCosmetics, "bigcountry", "Big Country");
	AddMenuItem(g_hPropMenuCosmetics, "bigdaddy", "Big Daddy");
	AddMenuItem(g_hPropMenuCosmetics, "bigelfindeal", "Big Elfin Deal");
	AddMenuItem(g_hPropMenuCosmetics, "bigtopper", "Big Topper");
	AddMenuItem(g_hPropMenuCosmetics, "birdcage", "Birdcage");
	AddMenuItem(g_hPropMenuCosmetics, "blackwatch", "Black Watch");
	AddMenuItem(g_hPropMenuCosmetics, "blastdefense", "Blast Defense");
	...
	AddMenuItem(g_hPropMenuCosmetics, "boltedbirdcage", "Bolted Birdcage");
	AddMenuItem(g_hPropMenuCosmetics, "boltedbushman", "Bolted Bushman");
	AddMenuItem(g_hPropMenuCosmetics, "bombbeanie", "Bomb Beanie");
	AddMenuItem(g_hPropMenuCosmetics, "bomberknight", "Bomber Knight");
	...
	AddMenuItem(g_hPropMenuCosmetics, "bozosbouffant", "Bozo's Bouffant");
	AddMenuItem(g_hPropMenuCosmetics, "brainwarmingwear", "Brain-Warming Wear");
	AddMenuItem(g_hPropMenuCosmetics, "brassbucket", "Brass Bucket");
	...
	AddMenuItem(g_hPropMenuCosmetics, "brockslocks", "Brock's Locks");
	AddMenuItem(g_hPropMenuCosmetics, "brucesbonnet", "Bruce's Bonnet");
	AddMenuItem(g_hPropMenuCosmetics, "bubblepipe", "Bubble Pipe");
	...
	AddMenuItem(g_hPropMenuCosmetics, "bulletbuzz", "Bullet Buzz");
	AddMenuItem(g_hPropMenuCosmetics, "bunsenbrave", "Bunsen Brave");
	AddMenuItem(g_hPropMenuCosmetics, "burningbandana", "Burning Bandana");
	...
	AddMenuItem(g_hPropMenuCosmetics, "burnysboneybonnet", "Burny's Boney Bonnet");
	AddMenuItem(g_hPropMenuCosmetics, "bushmansboonie", "Bushman's Boonie");
	AddMenuItem(g_hPropMenuCosmetics, "buzzkiller", "Buzz Killer");
	AddMenuItem(g_hPropMenuCosmetics, "cadaverscapper", "Cadaver's Capper");
	AddMenuItem(g_hPropMenuCosmetics, "cadaverscranium", "Cadaver's Cranium");
	AddMenuItem(g_hPropMenuCosmetics, "canopener", "Can Opener");
	AddMenuItem(g_hPropMenuCosmetics, "candymanscap", "Candyman's Cap");
	AddMenuItem(g_hPropMenuCosmetics, "caponescapper", "Capone's Capper");
	AddMenuItem(g_hPropMenuCosmetics, "caribbeanconqueror", "Caribbean Conqueror");
	AddMenuItem(g_hPropMenuCosmetics, "carl", "Carl");
	AddMenuItem(g_hPropMenuCosmetics, "carouserscapotain", "Carouser's Capotain");
	AddMenuItem(g_hPropMenuCosmetics, "catspajamas", "Cat's Pajamas");
	AddMenuItem(g_hPropMenuCosmetics, "centurion", "Centurion");
	AddMenuItem(g_hPropMenuCosmetics, "charmerschapeau", "Charmer's Chapeau");
	AddMenuItem(g_hPropMenuCosmetics, "cheatdetectedhonesty", "CheatDetectedHonesty");
	AddMenuItem(g_hPropMenuCosmetics, "cheatdetectedmajor", "CheatDetectedMajor");
	AddMenuItem(g_hPropMenuCosmetics, "cheatdetectedminor", "CheatDetectedMinor");
	AddMenuItem(g_hPropMenuCosmetics, "chickenkiev", "Chicken Kiev");
	...
	AddMenuItem(g_hPropMenuCosmetics, "climbingcommander", "Climbing Commander");
	...
	AddMenuItem(g_hPropMenuCosmetics, "coldkiller", "Cold Killer");
	AddMenuItem(g_hPropMenuCosmetics, "coldfrontcommander", "Coldfront Commander");
	AddMenuItem(g_hPropMenuCosmetics, "colossalcranium", "Colossal Cranium");
	AddMenuItem(g_hPropMenuCosmetics, "combatmedicscrushercap", "Combat Medic's Crusher Cap");
	AddMenuItem(g_hPropMenuCosmetics, "combustiblekabuto", "Combustible Kabuto");
	...
	AddMenuItem(g_hPropMenuCosmetics, "coolcapuchon", "Cool Capuchon");
	AddMenuItem(g_hPropMenuCosmetics, "coppershardtop", "Copper's Hard Top");
	AddMenuItem(g_hPropMenuCosmetics, "corpsemopolitan", "Corpsemopolitan");
	...
	AddMenuItem(g_hPropMenuCosmetics, "crackpot", "Crack Pot");
	AddMenuItem(g_hPropMenuCosmetics, "cranialcarcharodon", "Cranial Carcharodon");
	AddMenuItem(g_hPropMenuCosmetics, "crispygoldenlocks", "Crispy Golden Locks");
	AddMenuItem(g_hPropMenuCosmetics, "critcloak", "Crit Cloak");
	...
	AddMenuItem(g_hPropMenuCosmetics, "danger", "Danger");
	AddMenuItem(g_hPropMenuCosmetics, "dasblutliebhaber", "Das Blutliebhaber");
	AddMenuItem(g_hPropMenuCosmetics, "dasgutenkutteharen", "Das Gutenkutteharen");
	AddMenuItem(g_hPropMenuCosmetics, "dashazmattenhatten", "Das Hazmattenhatten");
	AddMenuItem(g_hPropMenuCosmetics, "dasmaddendoktor", "Das Maddendoktor");
	...
	AddMenuItem(g_hPropMenuCosmetics, "datamininglight", "Data Mining Light");
	AddMenuItem(g_hPropMenuCosmetics, "dayjogger", "Dayjogger");
	AddMenuItem(g_hPropMenuCosmetics, "deathracershelmet", "Death Racer's Helmet");
	AddMenuItem(g_hPropMenuCosmetics, "dec20142014_pyromancer_hood", "dec2014 2014_pyromancer_hood");
	AddMenuItem(g_hPropMenuCosmetics, "dec2014bigpapa", "dec2014 Big Papa");
	AddMenuItem(g_hPropMenuCosmetics, "dec2014comforter", "dec2014 Comforter");
	AddMenuItem(g_hPropMenuCosmetics, "dec2014engineer_detectiveglasses", "dec2014 engineer_detectiveglasses");
	AddMenuItem(g_hPropMenuCosmetics, "dec2014heavy_parka", "dec2014 heavy_parka");
	AddMenuItem(g_hPropMenuCosmetics, "dec2014hunter_ushanka", "dec2014 hunter_ushanka");
	AddMenuItem(g_hPropMenuCosmetics, "dec2014maraudersmask", "dec2014 Marauders Mask");
	AddMenuItem(g_hPropMenuCosmetics, "dec2014skullcap", "dec2014 Skullcap");
	AddMenuItem(g_hPropMenuCosmetics, "dec2014surgeonsshako", "dec2014 Surgeon's Shako");
	AddMenuItem(g_hPropMenuCosmetics, "dec2014vikinghelmet", "dec2014 Viking Helmet");
	AddMenuItem(g_hPropMenuCosmetics, "defiantspartan", "Defiant Spartan");
	AddMenuItem(g_hPropMenuCosmetics, "defragmentinghardhat17%", "Defragmenting Hard Hat 17%");
	...
	AddMenuItem(g_hPropMenuCosmetics, "demomansfro", "Demoman's Fro");
	AddMenuItem(g_hPropMenuCosmetics, "dermaschinensoldatenhelm", "Der Maschinensoldaten-Helm");
	AddMenuItem(g_hPropMenuCosmetics, "desertmarauder", "Desert Marauder");
	AddMenuItem(g_hPropMenuCosmetics, "detectivenoir", "Detective Noir");
	AddMenuItem(g_hPropMenuCosmetics, "dethkapp", "DethKapp");
	...
	AddMenuItem(g_hPropMenuCosmetics, "dreadhidinghood", "Dread Hiding Hood");
	AddMenuItem(g_hPropMenuCosmetics, "dumbbell", "Dumb Bell");
	AddMenuItem(g_hPropMenuCosmetics, "einstein", "Einstein");
	AddMenuItem(g_hPropMenuCosmetics, "eljefe", "El Jefe");
	AddMenuItem(g_hPropMenuCosmetics, "electricescorter", "Electric Escorter");
	AddMenuItem(g_hPropMenuCosmetics, "elfesteem", "Elf Esteem");
	AddMenuItem(g_hPropMenuCosmetics, "eliminatorssafeguard", "Eliminators Safeguard");
	AddMenuItem(g_hPropMenuCosmetics, "employeeofmmmph", "Employee of the Mmmph");
	...
	AddMenuItem(g_hPropMenuCosmetics, "eotl_flat_cap", "EOTL_Flat_cap");
	AddMenuItem(g_hPropMenuCosmetics, "eotl_soldier_garrison", "EOTL_soldier_garrison");
	AddMenuItem(g_hPropMenuCosmetics, "eotl_soldierhat", "EOTL_soldierhat");
	AddMenuItem(g_hPropMenuCosmetics, "eotl_summerhat", "EOTL_summerhat");
	AddMenuItem(g_hPropMenuCosmetics, "explosivemind", "Explosive Mind");
	...
	AddMenuItem(g_hPropMenuCosmetics, "fieldpractice", "Field Practice");
	AddMenuItem(g_hPropMenuCosmetics, "firewallhelmet", "Firewall Helmet");
	AddMenuItem(g_hPropMenuCosmetics, "firstamerican", "First American");
	...
	AddMenuItem(g_hPropMenuCosmetics, "flashofinspiration", "Flash of Inspiration");
	...
	AddMenuItem(g_hPropMenuCosmetics, "forgottenkingsrestlesshead", "Forgotten King's Restless Head");
	AddMenuItem(g_hPropMenuCosmetics, "fortunateson", "Fortunate Son");
	AddMenuItem(g_hPropMenuCosmetics, "fr0", "FR-0");
	AddMenuItem(g_hPropMenuCosmetics, "fragprooffragger", "Frag Proof Fragger");
	AddMenuItem(g_hPropMenuCosmetics, "freedomfears", "Freedom Feathers");
	AddMenuItem(g_hPropMenuCosmetics, "frontrunner", "Front Runner");
	AddMenuItem(g_hPropMenuCosmetics, "frontierdjustice", "Frontier Djustice");
	...
	AddMenuItem(g_hPropMenuCosmetics, "gauzedgaze", "Gauzed Gaze");
	...
	AddMenuItem(g_hPropMenuCosmetics, "glasgowgrealm", "Glasgow Great Helm");
	AddMenuItem(g_hPropMenuCosmetics, "glengarrybonnet", "Glengarry Bonnet");
	AddMenuItem(g_hPropMenuCosmetics, "gothicguise", "Gothic Guise");
	AddMenuItem(g_hPropMenuCosmetics, "grandduchesstiara", "Grand Duchess Tiara");
	AddMenuItem(g_hPropMenuCosmetics, "greasedlightning", "Greased Lightning");
	...
	AddMenuItem(g_hPropMenuCosmetics, "groundcontrol", "Ground Control");
	AddMenuItem(g_hPropMenuCosmetics, "gymrat", "Gym Rat");
	AddMenuItem(g_hPropMenuCosmetics, "hairofdog", "Hair of the Dog");
	AddMenuItem(g_hPropMenuCosmetics, "hallowedheadcase", "Hallowed Headcase");
	AddMenuItem(g_hPropMenuCosmetics, "halloweiner", "Halloweiner");
	AddMenuItem(g_hPropMenuCosmetics, "halogenheadlamp", "Halogen Head Lamp");
	AddMenuItem(g_hPropMenuCosmetics, "handsomehitman", "Handsome Hitman");
	AddMenuItem(g_hPropMenuCosmetics, "handymanshandle", "Handyman's Handle");
	AddMenuItem(g_hPropMenuCosmetics, "hangeronhood", "Hanger-On Hood");
	AddMenuItem(g_hPropMenuCosmetics, "hardcounter", "Hard Counter");
	AddMenuItem(g_hPropMenuCosmetics, "hardiumhelm", "Hardium Helm");
	AddMenuItem(g_hPropMenuCosmetics, "harmburg", "Harmburg");
	AddMenuItem(g_hPropMenuCosmetics, "hatofcards", "Hat of Cards");
	AddMenuItem(g_hPropMenuCosmetics, "hawkeyedhunter", "Hawk Eyed Hunter");
	AddMenuItem(g_hPropMenuCosmetics, "headhunter", "Head Hunter");
	AddMenuItem(g_hPropMenuCosmetics, "headwarmer", "Head Warmer");
	AddMenuItem(g_hPropMenuCosmetics, "headtakershood", "Headtaker's Hood");
	AddMenuItem(g_hPropMenuCosmetics, "heavyartilleryofficerscap", "Heavy Artillery Officer's Cap");
	AddMenuItem(g_hPropMenuCosmetics, "heavydorag", "Heavy Do-rag");
	AddMenuItem(g_hPropMenuCosmetics, "heavyhair", "Heavy Hair");
	AddMenuItem(g_hPropMenuCosmetics, "heavytopknot", "Heavy Topknot");
	AddMenuItem(g_hPropMenuCosmetics, "heershelmet", "Heer's Helmet");
	AddMenuItem(g_hPropMenuCosmetics, "hellhuntersheadpiece", "Hellhunter's Headpiece");
	AddMenuItem(g_hPropMenuCosmetics, "hellmet", "Hellmet");
	AddMenuItem(g_hPropMenuCosmetics, "helmetwithoutahome", "Helmet Without a Home");
	AddMenuItem(g_hPropMenuCosmetics, "hephaistoshandcraft", "Hephaistos' Handcraft");
	AddMenuItem(g_hPropMenuCosmetics, "heraldshelm", "Herald's Helm");
	AddMenuItem(g_hPropMenuCosmetics, "hermes", "Hermes");
	AddMenuItem(g_hPropMenuCosmetics, "heroshachimaki", "Hero's Hachimaki");
	AddMenuItem(g_hPropMenuCosmetics, "herostail", "Hero's Tail");
	AddMenuItem(g_hPropMenuCosmetics, "hiddendragon", "Hidden Dragon");
	AddMenuItem(g_hPropMenuCosmetics, "highwaystar", "Highway Star");
	AddMenuItem(g_hPropMenuCosmetics, "hiveminder", "Hive Minder");
	AddMenuItem(g_hPropMenuCosmetics, "holyhunter", "Holy Hunter");
	AddMenuItem(g_hPropMenuCosmetics, "honchosheadgear", "Honcho's Headgear");
	AddMenuItem(g_hPropMenuCosmetics, "honesthalo", "Honest Halo");
	AddMenuItem(g_hPropMenuCosmetics, "hoodofsorrows", "Hood of Sorrows");
	AddMenuItem(g_hPropMenuCosmetics, "hornedhoncho", "Horned Honcho");
	AddMenuItem(g_hPropMenuCosmetics, "horrificheadofhare", "Horrific Head of Hare");
	AddMenuItem(g_hPropMenuCosmetics, "hottieshoodie", "Hottie's Hoodie");
	AddMenuItem(g_hPropMenuCosmetics, "houndshood", "Hound's Hood");
	AddMenuItem(g_hPropMenuCosmetics, "hungoverhero", "Hungover Hero");
	AddMenuItem(g_hPropMenuCosmetics, "hyperbaricbowler", "Hyperbaric Bowler");
	...
	AddMenuItem(g_hPropMenuCosmetics, "katyusha", "Katyusha");
	AddMenuItem(g_hPropMenuCosmetics, "lhommeburglerre", "L'homme Burglerre");
	AddMenuItem(g_hPropMenuCosmetics, "linspecteur", "L'Inspecteur");
	AddMenuItem(g_hPropMenuCosmetics, "lackingmoralfibermask", "Lacking Moral Fiber Mask");
	AddMenuItem(g_hPropMenuCosmetics, "larrikinrobin", "Larrikin Robin");
	AddMenuItem(g_hPropMenuCosmetics, "larvallid", "Larval Lid");
	AddMenuItem(g_hPropMenuCosmetics, "laststraw", "Last Straw");
	AddMenuItem(g_hPropMenuCosmetics, "letchsled", "Letch's LED");
	AddMenuItem(g_hPropMenuCosmetics, "lightninglid", "Lightning Lid");
	AddMenuItem(g_hPropMenuCosmetics, "liquidatorslid", "Liquidator's Lid");
	AddMenuItem(g_hPropMenuCosmetics, "littlebuddy", "Little Buddy");
	AddMenuItem(g_hPropMenuCosmetics, "lonestar", "Lone Star");
	...
	AddMenuItem(g_hPropMenuCosmetics, "macabremask", "Macabre Mask");
	...
	AddMenuItem(g_hPropMenuCosmetics, "mannofreason", "Mann of Reason");
	AddMenuItem(g_hPropMenuCosmetics, "mannbirdofaberdeen", "Mann-Bird of Aberdeen");
	AddMenuItem(g_hPropMenuCosmetics, "mannowar", "Mann-O-War");
	AddMenuItem(g_hPropMenuCosmetics, "marsupialman", "Marsupial Man");
	AddMenuItem(g_hPropMenuCosmetics, "maskofshaman", "Mask of the Shaman");
	AddMenuItem(g_hPropMenuCosmetics, "mastermind", "Master Mind");
	...
	AddMenuItem(g_hPropMenuCosmetics, "medimedes", "Medimedes");
	AddMenuItem(g_hPropMenuCosmetics, "metalslug", "Metal Slug");
	AddMenuItem(g_hPropMenuCosmetics, "mightymitre", "Mighty Mitre");
	AddMenuItem(g_hPropMenuCosmetics, "milkman", "Milkman");
	AddMenuItem(g_hPropMenuCosmetics, "millennialmercenary", "Millennial Mercenary");
	AddMenuItem(g_hPropMenuCosmetics, "minnesotaslick", "Minnesota Slick");
	AddMenuItem(g_hPropMenuCosmetics, "minskbeef", "Minsk Beef");
	AddMenuItem(g_hPropMenuCosmetics, "mishapmercenary", "Mishap Mercenary");
	AddMenuItem(g_hPropMenuCosmetics, "mncmascothat", "MNC Mascot Hat");
	AddMenuItem(g_hPropMenuCosmetics, "mohorn", "Mo'Horn");
	AddMenuItem(g_hPropMenuCosmetics, "mucousmembrain", "Mucous Membrain");
	AddMenuItem(g_hPropMenuCosmetics, "murderersmotif", "Murderer's Motif");
	AddMenuItem(g_hPropMenuCosmetics, "mvmgatebotlightdemoman", "MvM GateBot Light Demoman");
	AddMenuItem(g_hPropMenuCosmetics, "mvmgatebotlightengineer", "MvM GateBot Light Engineer");
	AddMenuItem(g_hPropMenuCosmetics, "mvmgatebotlightmedic", "MvM GateBot Light Medic");
	AddMenuItem(g_hPropMenuCosmetics, "mvmgatebotlightpyro", "MvM GateBot Light Pyro");
	AddMenuItem(g_hPropMenuCosmetics, "mvmgatebotlightscout", "MvM GateBot Light Scout");
	AddMenuItem(g_hPropMenuCosmetics, "mvmgatebotlightsniper", "MvM GateBot Light Sniper");
	AddMenuItem(g_hPropMenuCosmetics, "mvmgatebotlightsoldier", "MvM GateBot Light Soldier");
	AddMenuItem(g_hPropMenuCosmetics, "mvmgatebotlightspy", "MvM GateBot Light Spy");
	...
	AddMenuItem(g_hPropMenuCosmetics, "neptunesnightmare", "Neptune's Nightmare");
	AddMenuItem(g_hPropMenuCosmetics, "nightmarehunter", "Nightmare Hunter");
	AddMenuItem(g_hPropMenuCosmetics, "ninjacowl", "Ninja Cowl");
	AddMenuItem(g_hPropMenuCosmetics, "nuggetnoggin", "Nugget Noggin");
	AddMenuItem(g_hPropMenuCosmetics, "nunhood", "Nunhood");
	...
	AddMenuItem(g_hPropMenuCosmetics, "onemanarmy", "One-Man Army");
	...
	AddMenuItem(g_hPropMenuCosmetics, "outtasight", "Outta' Sight");
	AddMenuItem(g_hPropMenuCosmetics, "pamperedpyro", "Pampered Pyro");
	AddMenuItem(g_hPropMenuCosmetics, "pardnerspompadour", "Pardner's Pompadour");
	AddMenuItem(g_hPropMenuCosmetics, "peaceniksponytail", "Peacenik's Ponytail");
	AddMenuItem(g_hPropMenuCosmetics, "personinironmask", "Person in the Iron Mask");
	AddMenuItem(g_hPropMenuCosmetics, "physiciansprotector", "Physician's Protector");
	AddMenuItem(g_hPropMenuCosmetics, "pilotka", "Pilotka");
	AddMenuItem(g_hPropMenuCosmetics, "piratebandana", "Pirate Bandana");
	...
	AddMenuItem(g_hPropMenuCosmetics, "plumberscap", "Plumber's Cap");
	AddMenuItem(g_hPropMenuCosmetics, "plumberspipe", "Plumber's Pipe");
	...
	AddMenuItem(g_hPropMenuCosmetics, "pompommedprovocateur", "Pom-Pommed Provocateur");
	AddMenuItem(g_hPropMenuCosmetics, "pomadeprince", "Pomade Prince");
	AddMenuItem(g_hPropMenuCosmetics, "poundingfar", "Pounding Father");
	...
	AddMenuItem(g_hPropMenuCosmetics, "punkspomp", "Punk's Pomp");
	AddMenuItem(g_hPropMenuCosmetics, "puretincapotain", "Pure Tin Capotain");
	AddMenuItem(g_hPropMenuCosmetics, "pyrobrainsucker", "Pyro Brain Sucker");
	AddMenuItem(g_hPropMenuCosmetics, "pyrohelm", "Pyro Helm");
	AddMenuItem(g_hPropMenuCosmetics, "pyroflamedeer", "Pyro the Flamedeer");
	...
	AddMenuItem(g_hPropMenuCosmetics, "randolphbloodnosedcaribou", "Randolph the Blood-Nosed Caribou");
	AddMenuItem(g_hPropMenuCosmetics, "ravensvisage", "Raven's Visage");
	AddMenuItem(g_hPropMenuCosmetics, "razorcut", "Razor Cut");
	AddMenuItem(g_hPropMenuCosmetics, "rebelrouser", "Rebel Rouser");
	AddMenuItem(g_hPropMenuCosmetics, "reggaelator", "Reggaelator");
	...
	AddMenuItem(g_hPropMenuCosmetics, "ritzyrickshairfixative", "Ritzy Rick's Hair Fixative");
	AddMenuItem(g_hPropMenuCosmetics, "robotrunningman", "Robot Running Man");
	AddMenuItem(g_hPropMenuCosmetics, "roguesrabbit", "Rogue's Rabbit");
	AddMenuItem(g_hPropMenuCosmetics, "runnerswarmup", "Runner's Warm-Up");
	AddMenuItem(g_hPropMenuCosmetics, "sammycap", "Sammy Cap");
	...
	AddMenuItem(g_hPropMenuCosmetics, "shadowmansshade", "Shadowman's Shade");
	AddMenuItem(g_hPropMenuCosmetics, "shamansskull", "Shaman's Skull");
	AddMenuItem(g_hPropMenuCosmetics, "shellmet", "Shellmet");
	AddMenuItem(g_hPropMenuCosmetics, "sheriffsstetson", "Sheriff's Stetson");
	...
	AddMenuItem(g_hPropMenuCosmetics, "sirshootsalot", "Sir Shootsalot");
	AddMenuItem(g_hPropMenuCosmetics, "skyhighflyguy", "Sky High Fly Guy");
	AddMenuItem(g_hPropMenuCosmetics, "slickcut", "Slick Cut");
	AddMenuItem(g_hPropMenuCosmetics, "slopoke", "Slo-Poke");
	AddMenuItem(g_hPropMenuCosmetics, "smissmascaribou", "Smissmas Caribou");
	AddMenuItem(g_hPropMenuCosmetics, "smokeysombrero", "Smokey Sombrero");
	AddMenuItem(g_hPropMenuCosmetics, "smokingskidlid", "Smoking Skid Lid");
	...
	AddMenuItem(g_hPropMenuCosmetics, "snowcapped", "Snowcapped");
	AddMenuItem(g_hPropMenuCosmetics, "soberstuntman", "Sober Stuntman");
	AddMenuItem(g_hPropMenuCosmetics, "solderedsensei", "Soldered Sensei");
	...
	AddMenuItem(g_hPropMenuCosmetics, "solemate", "Sole Mate");
	AddMenuItem(g_hPropMenuCosmetics, "sovietgentleman", "Soviet Gentleman");
	AddMenuItem(g_hPropMenuCosmetics, "spectralnaut", "Spectralnaut");
	AddMenuItem(g_hPropMenuCosmetics, "spellbindersbonnet", "Spellbinder's Bonnet");
	AddMenuItem(g_hPropMenuCosmetics, "spiritofbombingpast", "Spirit of the Bombing Past");
	AddMenuItem(g_hPropMenuCosmetics, "spookspecs", "Spook Specs");
	AddMenuItem(g_hPropMenuCosmetics, "spyberet", "Spy Beret");
	AddMenuItem(g_hPropMenuCosmetics, "spynoblehair", "Spy Noble Hair");
	AddMenuItem(g_hPropMenuCosmetics, "squidslid", "Squid's Lid");
	...
	AddMenuItem(g_hPropMenuCosmetics, "storminnorman", "Stormin' Norman");
	...
	AddMenuItem(g_hPropMenuCosmetics, "stylishdegroot", "Stylish DeGroot");
	AddMenuItem(g_hPropMenuCosmetics, "suckerslug", "Sucker Slug");
	...
	AddMenuItem(g_hPropMenuCosmetics, "tanktop", "Tank Top");
	AddMenuItem(g_hPropMenuCosmetics, "tartanshade", "Tartan Shade");
	AddMenuItem(g_hPropMenuCosmetics, "tartanspartan", "Tartan Spartan");
	...
	AddMenuItem(g_hPropMenuCosmetics, "teutonkahmun", "Teutonkahmun");
	AddMenuItem(g_hPropMenuCosmetics, "texasslimsdomeshine", "Texas Slim's Dome Shine");
	...
	AddMenuItem(g_hPropMenuCosmetics, "thirstblood", "Thirst Blood");
	AddMenuItem(g_hPropMenuCosmetics, "timelesstopper", "Timeless Topper");
	AddMenuItem(g_hPropMenuCosmetics, "tin1000", "Tin-1000");
	AddMenuItem(g_hPropMenuCosmetics, "tinytexan", "Tiny Texan");
	...
	AddMenuItem(g_hPropMenuCosmetics, "transylvaniatop", "Transylvania Top");
	AddMenuItem(g_hPropMenuCosmetics, "transylvaniantoupe", "Transylvanian Toupe");
	AddMenuItem(g_hPropMenuCosmetics, "trashman", "Trash Man");
	AddMenuItem(g_hPropMenuCosmetics, "trencherstopper", "Trencher's Topper");
	AddMenuItem(g_hPropMenuCosmetics, "trepanabotomizer", "Trepanabotomizer");
	AddMenuItem(g_hPropMenuCosmetics, "triclops", "Triclops");
	AddMenuItem(g_hPropMenuCosmetics, "trophybelt", "Trophy Belt");
	AddMenuItem(g_hPropMenuCosmetics, "tsarboosh", "Tsarboosh");
	AddMenuItem(g_hPropMenuCosmetics, "tungstentoque", "Tungsten Toque");
	AddMenuItem(g_hPropMenuCosmetics, "tw_demobot_helmet", "tw_demobot_helmet");
	AddMenuItem(g_hPropMenuCosmetics, "tw_engineerbot_helmet", "tw_engineerbot_helmet");
	AddMenuItem(g_hPropMenuCosmetics, "tw_heavybot_helmet", "tw_heavybot_helmet");
	AddMenuItem(g_hPropMenuCosmetics, "tw_medibot_hat", "tw_medibot_hat");
	AddMenuItem(g_hPropMenuCosmetics, "tw_pyrobot_helmet", "tw_pyrobot_helmet");
	AddMenuItem(g_hPropMenuCosmetics, "tw_scoutbot_hat", "tw_scoutbot_hat");
	AddMenuItem(g_hPropMenuCosmetics, "tw_sniperbot_helmet", "tw_sniperbot_helmet");
	AddMenuItem(g_hPropMenuCosmetics, "tw_soldierbot_helmet", "tw_soldierbot_helmet");
	AddMenuItem(g_hPropMenuCosmetics, "tw_spybot_hood", "tw_spybot_hood");
	...
	AddMenuItem(g_hPropMenuCosmetics, "undercover", "Under Cover");
	AddMenuItem(g_hPropMenuCosmetics, "upgrade", "Upgrade");
	AddMenuItem(g_hPropMenuCosmetics, "valleyforge", "Valley Forge");
	AddMenuItem(g_hPropMenuCosmetics, "vampirevanquisher", "Vampire Vanquisher");
	...
	AddMenuItem(g_hPropMenuCosmetics, "voidmonkhair", "Void Monk Hair");
	...
	AddMenuItem(g_hPropMenuCosmetics, "waronsmissmasbattlehood", "War on Smissmas Battle Hood");
	AddMenuItem(g_hPropMenuCosmetics, "warpig", "War Pig");
	AddMenuItem(g_hPropMenuCosmetics, "warhood", "Warhood");
	AddMenuItem(g_hPropMenuCosmetics, "waxywayfinder", "Waxy Wayfinder");
	...
	AddMenuItem(g_hPropMenuCosmetics, "whiterussian", "White Russian");
	AddMenuItem(g_hPropMenuCosmetics, "widebrimmedbandito", "Wide-Brimmed Bandito");
	AddMenuItem(g_hPropMenuCosmetics, "wingmann", "Wing Mann");
	AddMenuItem(g_hPropMenuCosmetics, "wormsgear", "Worms Gear");
	AddMenuItem(g_hPropMenuCosmetics, "wraithwrap", "Wraith Wrap");
	AddMenuItem(g_hPropMenuCosmetics, "wrapbattler", "Wrap Battler");
	...
	AddMenuItem(g_hPropMenuCosmetics, "yeti_head", "Yeti_Head");
	AddMenuItem(g_hPropMenuCosmetics, "yourworstnightmare", "Your Worst Nightmare");
	AddMenuItem(g_hPropMenuCosmetics, "zipperface", "Zipperface");

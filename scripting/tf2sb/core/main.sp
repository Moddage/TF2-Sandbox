...
public void OnPluginStart_Main()
{
	// cvars
...
public void OnLibraryAdded_Main(const char[] name)
{
	#if defined _updater_included
...
public void OnClientPutInServer_Main(int client)
{
